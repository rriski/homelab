...
Because [this project](https://github.com/rriski/homelab) applies GitOps practices,
it's the source of truth for _my_ homelab, so you'll need to fork it to make it yours:

[:fontawesome-solid-code-fork: Fork rriski/homelab](https://github.com/rriski/homelab/fork){ .md-button }
