...
**[Features](#features) • [Get Started](#get-started) • [Documentation](https://homelab.timoriski.fi)**

[![tag](https://img.shields.io/github/v/tag/rriski/homelab?style=flat-square&logo=semver&logoColor=white)](https://github.com/rriski/homelab/tags)
[![document](https://img.shields.io/website?label=document&logo=gitbook&logoColor=white&style=flat-square&url=https%3A%2F%2Fhomelab.rriski.com)](https://homelab.rriski.com)
[![license](https://img.shields.io/github/license/rriski/homelab?style=flat-square&logo=gnu&logoColor=white)](https://www.gnu.org/licenses/gpl-3.0.html)
[![stars](https://img.shields.io/github/stars/rriski/homelab?logo=github&logoColor=white&color=gold&style=flat-square)](https://github.com/rriski/homelab)
...
- [x] Common applications: Gitea, Seafile, Jellyfin...
...
- [Try it out locally](https://homelab.timoriski.fi/installation/sandbox) without any hardware  (just 4 commands!)
- [Deploy on real hardware](https://homelab.timoriski.fi/installation/production/prerequisites) for production workload

## Roadmap

See [roadmap](https://homelab.timoriski.fi/reference/roadmap) and [open issues](https://github.com/rriski/homelab/issues) for a list of proposed features and known issues.

## Contributing

Any contributions you make are greatly appreciated.

Please see [contributing guide](https://homelab.timoriski.fi/reference/contributing) for more information.
...
See [license page](https://homelab.timoriski.fi/reference/license) or `LICENSE.md` file for more information.
...
[![Stargazers over time](https://starchart.cc/rriski/homelab.svg)](https://starchart.cc/rriski/homelab)
